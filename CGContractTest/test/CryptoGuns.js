    ...
    //
       context("Duplicate Upgrade", async () => {
           it("should burn the duplicate swat", async () => {
              const swat1 = await this.contractInstance.mintSpecificSwat(owner, "nightmare", "legendary", {from: owner});
              const swat2 = await this.contractInstance.mintSpecificSwat(owner, "basicbob", "common", {from: owner});
